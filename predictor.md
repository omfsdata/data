...
Curious how your stats stack up? This tool takes four inputs — CBSE, class rank, externships, and research — and returns a **predicted interview conversion rate** based on a simple model that was trained on the SDN dataset. Drag the sliders to enter your stats and watch it update.
...
<iframe src="{{ 'https://omfsdata.com/assets/predictor.html' | relative_url }}" width="100%" height="520"
...
* * Think of this as a way to feel how the model weighs each factor — nudge the CBSE slider and watch it move more than the others — rather than a forecast of your cycle. It’s a mirror of past forum data, not a crystal ball.
